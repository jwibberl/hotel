...
$formbookingid = isset($_GET['bookingid']) ? (int)$_GET['bookingid'] : null;
...
");
$stmt->execute(['bookingid' => $formbookingid]);
...
<title>Hotel Aurora • Booking Details</title>
...
th { text-align:left; background: rgba(0,217,217,0.2); color:#00d9d9; font-weight:600; padding:12px; border-bottom:2px solid rgba(255,255,255,0.1); }
...
<main>
    ...
    <section class="content">
        ...
        <table>
            ...
            <tr>
                <td><?php echo esc($booking['customername']); ?></td>
                <td><?php echo esc($booking['roomname']); ?></td>
                <td><?php echo esc($booking['datefrom']); ?></td>
